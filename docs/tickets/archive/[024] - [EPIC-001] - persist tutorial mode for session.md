...
- The user explicitly controls tutorial mode through the floating tutorial icon.
- The floating tutorial icon active/off styling should make the current state clear.
...
- Floating tutorial icon state behavior.
